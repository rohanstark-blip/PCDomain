                ...
                <div className="container mx-auto px-4 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div ref={(el) => sectionsRef.current[5] = el} className="opacity-0">
                            <FeatureCard icon={<TrendingUp className="w-8 h-8 text-lime-400"/>} title="Real-Time Price Tracking" description="Stay updated with current market prices to get accurate costs for your build." style={{animationDelay: '500ms'}} />
                        </div>
