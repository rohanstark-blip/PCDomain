        ...
        <div className="font-sans flex flex-col min-h-screen">
            ...
            <main className="flex-grow flex items-center justify-center p-4">
                <div className="w-full max-w-md opacity-0 animate-fadeInUp">
                    <form onSubmit={handleLogin} className="glassmorphic rounded-xl p-8 shadow-2xl space-y-6 glowing-border">
                        <div className="text-center">
                            <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-teal-400">Welcome Back</h1>
                        ...
                        <button type="submit" className="w-full bg-cyan-500 hover:bg-cyan-600 transition-colors text-white font-bold py-2.5 px-5 rounded-lg text-center">Login</button>
                        <p className="text-sm text-center text-gray-400">
                            Don't have an account? <button type="button" onClick={() => onNavigate('signup')} className="font-medium text-cyan-400 hover:underline">Sign up here</button>
                        </p>
                    </form>
                </div>
            </main>
